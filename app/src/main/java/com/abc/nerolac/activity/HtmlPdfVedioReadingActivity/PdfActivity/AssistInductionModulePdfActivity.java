...
public class AssistInductionModulePdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_assist_induction_module_pdf);
        ...
        File file = new File(appDirectory + "/KnowledgeBase/SELF TRAINING/INDUCTION MODULE FRONTLINERS/"+pdfName+".pdf");
        ...
        if(file.exists()) {
            ...
            try {
                ...
                Toast.makeText(AssistInductionModulePdfActivity.this, "No Application Available to View PDF",
                        Toast.LENGTH_SHORT).show();
            }
        }else {
            Toast.makeText(AssistInductionModulePdfActivity.this, "PDF does not exixt",
                    Toast.LENGTH_SHORT).show();
            finish();
        }
    }
