...
public class AwareCorporateImpressionPdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aware_corporate_impression_pdf);
        ...
        File file = new File(appDirectory + "/KnowledgeBase/HR/Corporate Communication/Impression Newsletter/" + pdfName + ".pdf");
...
//            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            try {
                ...
                Toast.makeText(AwareCorporateImpressionPdfActivity.this, "No Application Available to View PDF",
                        Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(AwareCorporateImpressionPdfActivity.this, "PDF does not exixt",
                    Toast.LENGTH_SHORT).show();
            finish();
        }
    }
