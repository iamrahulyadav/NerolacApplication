...
public class AwareHumanResourcePdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_human_resource_pdf);
        ...
        File file = new File(appDirectory + "/KnowledgeBase/HR/Human Resources/"+pdfName+".pdf");
        ...
        if(file.exists()) {
            ...
            try {
                ...
                Toast.makeText(AwareHumanResourcePdfActivity.this, "No Application Available to View PDF",
                        Toast.LENGTH_SHORT).show();
            }
        }else {
            Toast.makeText(AwareHumanResourcePdfActivity.this, "Pdf doest not exixt",
                    Toast.LENGTH_SHORT).show();
