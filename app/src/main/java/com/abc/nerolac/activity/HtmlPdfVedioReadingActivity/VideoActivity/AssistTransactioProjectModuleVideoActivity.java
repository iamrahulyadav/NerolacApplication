...
public class AssistTransactioProjectModuleVideoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assist_transactio_project_module_video);
        VideoView videoView;
        ...
        File file = new File(appDirectory+"/KnowledgeBase/SELF TRAINING/Transaction/Project Module/"+videoName+".mp4");

        String file1 = appDirectory+"/KnowledgeBase/SELF TRAINING/Transaction/Project Module/"+videoName+".mp4";
