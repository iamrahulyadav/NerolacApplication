...
public class AssistOtherVideoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assist_other_video);
        ...
        File file = new File(appDirectory+"/KnowledgeBase/SELF TRAINING/Others/"+videoName+".mp4");

        String file1 = appDirectory+"/KnowledgeBase/SELF TRAINING/Others/"+videoName+".mp4";
