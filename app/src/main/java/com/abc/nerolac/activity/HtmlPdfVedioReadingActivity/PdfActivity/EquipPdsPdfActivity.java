...
public class EquipPdsPdfActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_equip_pds_pdf);
        ...
        if(file.exists()) {
            ...
            try {
                ...
                Toast.makeText(EquipPdsPdfActivity.this, "No Application Available to View PDF",
                        Toast.LENGTH_SHORT).show();
            }
        }else {
            Toast.makeText(EquipPdsPdfActivity.this, "PDF does not exixt",
                    Toast.LENGTH_SHORT).show();
