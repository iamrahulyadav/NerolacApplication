...
import com.abc.nerolac.activity.AwareCorporateCommunicationActivity;
import com.abc.nerolac.model.AwareModel;

import java.io.File;

public class AwareCorporateCommunicationPdfActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ho_communication_pdf);
        ...
        File file = new File(appDirectory + "/KnowledgeBase/HR/Corporate Communication/" + pdfName + ".pdf");
...
//            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            try {
                ...
                Toast.makeText(AwareCorporateCommunicationPdfActivity.this, "No Application Available to View PDF",
                        Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(AwareCorporateCommunicationPdfActivity.this, "PDF does not exixt",
                    Toast.LENGTH_SHORT).show();
            finish();
        }
    }
