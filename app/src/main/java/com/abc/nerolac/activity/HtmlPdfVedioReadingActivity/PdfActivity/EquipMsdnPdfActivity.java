...
public class EquipMsdnPdfActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_equip_msdn_pdf);

        Intent intentEquipMsdn = getIntent();
        String pdfName = intentEquipMsdn.getStringExtra("MSDN");
        ...
        try
        {
            ...
            Toast.makeText(EquipMsdnPdfActivity.this, "No Application Available to View PDF",
