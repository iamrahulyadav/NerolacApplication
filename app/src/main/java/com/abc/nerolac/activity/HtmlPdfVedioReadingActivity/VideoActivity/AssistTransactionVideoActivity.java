...
public class AssistTransactionVideoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_assist_transaction_video);
        ...
        File file = new File(appDirectory+"/KnowledgeBase/SELF TRAINING/Transaction/"+videoName+".mp4");


        String file1 = appDirectory+"/KnowledgeBase/SELF TRAINING/Transaction/"+videoName+".mp4";
